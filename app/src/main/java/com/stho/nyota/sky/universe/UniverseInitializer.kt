...
class UniverseInitializer(universe: Universe) : AbstractUniverseInitializer(universe) {
    ...
    private fun registerHydra() {
        ...
        val theta = newStar( Symbol.THETA, "08h 43m 13.47499", "+03° 23′ 55.1867", 3.888)
        ...
        val omicron = newStar( Symbol.OMICRON, "11h 40m 12.78970", "−34° 44′ 40.7733", 4.70)
    ...
    private fun registerAries() {
        ...
        val x41 = newStar(Symbol.FORTY_ONE, "02h 49m 59.03324", "+27° 15′ 37.8260", 3.63)
    ...
    private fun registerTaurus() {
        ...
        val omicron = newStar(Symbol.OMICRON, "03h 24m 48.79796", "+09° 01′ 43.9489", 3.61)
    ...
    private fun registerLeo() {
        ...
        val omicron = newStar(Symbol.OMICRON, "09h 41m 09.03", "+09° 53′ 32.30", 3.52)
    ...
    private fun registerCapricornus() {
        ...
        val omicron = newStar(Symbol.OMICRON, "20h 29m 53.91117", "−18° 34′ 59.4803", 5.94)
    ...
    private fun registerPisces() {
        ...
        val omicron = newStar(Symbol.OMICRON, "01h 45m 23.63185", "+09° 09′ 27.8530", 4.27)
