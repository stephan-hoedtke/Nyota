...
class SphereToPlainProjection : ISphereProjection {
    ...
    private fun isExcluded(z1: Double): Boolean =
        z1 < TOLERANCE // it is behind the observer

    companion object {
        private val TOLERANCE = Degree.cos(85.0)
    }
}


class SphereToSphereProjection : ISphereProjection {
    private var zoom: Double = 1.0
    private var centerAzimuth = 0.0
    private var cos = 0.0
    private var sin = 0.0
